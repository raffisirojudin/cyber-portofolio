const IMAGE_SRCS = [
  "lab-assets/01-cv-builder.png",
  "lab-assets/02-web-generator.png",
  "lab-assets/03-hardening-suite.png",
  "lab-assets/04-whitehat-academy.png",
  "lab-assets/05-blueteam-suite.png",
  "lab-assets/06-photo-studio.png"
];

// Real aspect ratios (width / height) for each screenshot — none are
// square, so every face uses object-fit:contain to show the full UI
// without cropping off buttons/text.
const IMAGE_ASPECTS = [1.306, 2.798, 1.835, 1.65, 1.206, 2.273];
