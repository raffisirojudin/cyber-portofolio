...
(function () {
  var CASE_STUDIES = {
    ...
    kinetic: {
      ...
      result:
        "Aplikasi berjalan smooth 60 FPS dengan 120+ partikel aktif di browser manapun. User bisa menghasilkan karya unik setiap saat dengan kombinasi mode dan palette yang berbeda.",
      features: [
    ...
    lentera: {
      ...
      title: "Lentera Kecil",
      problem:
        "Anak-anak Indonesia kehilangan akses ke dongeng tradisional Nusantara yang interaktif. Konten digital anak yang ada mayoritas berformat video pasif dan tidak adaptif.",
      solution:
        "Mesin dongeng interaktif dengan 17 cerita rakyat Nusantara, karakter SVG animasi original, background scene dinamis, ambient sound procedural, dan sistem progress berbintang.",
      result:
        "Platform yang dapat dinikmati anak usia 4–10 tahun tanpa koneksi internet, dengan 17 cerita lengkap dengan pesan moral, sistem bintang yang mendorong engagement.",
      features: [
        "📚 17 Dongeng Nusantara",
    ...
    easysolve: {
      ...
      solution:
        "Platform kalkulator sains komprehensif dengan 100+ rumus dari 7 mata pelajaran yang tidak hanya memberikan hasil, tetapi juga menampilkan langkah pengerjaan step-by-step dengan render KaTeX.",
      result:
    ...
    neuroshelf: {
      ...
      solution:
        "Sistem visualisasi pengetahuan berbasis Force-Directed Graph menggunakan D3.js dengan auto-linking berbasis keyword matching, BFS path finder, Convex Hull grouping, minimap, undo/redo, dan export PNG.",
      result:
    ...
    profitpath: {
      tag: "Business Simulator",
      tagColor: "#00d4ff",
      title: "ProfitPath Elite",
      problem:
        "Calon pengusaha pemula sering membuat keputusan bisnis berdasarkan intuisi tanpa data. Tidak ada alat simulasi interaktif yang bisa mengajarkan logika bisnis secara visual dan real-time.",
      solution:
        "Simulator strategi bisnis berbasis probabilistik dengan onboarding 3 langkah, dashboard KPI real-time, proyeksi cash flow 3 skenario menggunakan model probabilistik, business coach berbasis pattern recognition, customer journey funnel, dan surprise event untuk melatih ketahanan terhadap variabel eksternal.",
      result:
        "Calon pengusaha dapat mensimulasikan 12 bulan bisnis dalam hitungan detik, melihat dampak keputusan keuangan secara langsung, dan mendapat coaching otomatis berbasis logika bisnis — sebelum menginvestasikan modal nyata.",
      features: [
        "📊 KPI Dashboard Real-time",
        "🎲 Fortune Teller (Stress Test Probabilistik)",
        "🤖 Business Coach AI (Logic-based)",
        "🔽 Customer Journey Funnel",
        "⚡ Surprise Event Simulator",
        "💊 Business Health Score",
        "📁 4 Template Bisnis Siap Pakai",
        "🧭 Guided Onboarding 3 Langkah",
      ],
      tech: ["HTML", "CSS", "JavaScript", "Chart.js", "Probabilistic Engine"],
      previewBg: "linear-gradient(135deg,#050a0e,#0d1821)",
      previewEmoji: "📈",
    },
  };
  ...
  function openCaseStudy(key) {
    ...
    var featEl = document.getElementById("cs-features");
    ...
    var techEl = document.getElementById("cs-tech");
    techEl.innerHTML = d.tech
      .map(function (t) {
